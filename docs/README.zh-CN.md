...
- `REAL_REPO_EVALUATION.md` / `REAL_REPO_EVALUATION.zh-CN.md`：真实仓库评估记录。
- `PERFORMANCE_BENCHMARKS.md` / `PERFORMANCE_BENCHMARKS.zh-CN.md`：30 秒性能基准结果和命令。

资源：

- `assets/report-preview.png`：README 报告预览图。
