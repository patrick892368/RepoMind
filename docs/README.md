...
- `ROUTE_PREFIX_STRATEGY.md` / `ROUTE_PREFIX_STRATEGY.zh-CN.md`: cross-file route prefix resolution plan.

Validation and evaluation:

- `REAL_REPO_EVALUATION.md` / `REAL_REPO_EVALUATION.zh-CN.md`: real repository analysis notes.
- `PERFORMANCE_BENCHMARKS.md` / `PERFORMANCE_BENCHMARKS.zh-CN.md`: 30-second benchmark results and commands.

Assets:

- `assets/report-preview.png`: README report preview image.
